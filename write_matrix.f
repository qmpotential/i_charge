...
C     ------------------------------------------------------------------
C               Adding an additional row and column to the matrix A(i,j)

      if ( j == ATM ) A(i,j+1) = single_chg
      if ( i == ATM ) A(i+1,j) = single_chg
      
  150 enddo

      if ( i == ATM .and. j == ATM ) A(i+1,j+1) = total_chg
